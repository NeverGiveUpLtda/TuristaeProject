...
import com.app.turistae.databinding.ActivityMenuNavigationBinding;
...
public class Menu_Navigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarMenuNavigation2.toolbar);
        binding.appBarMenuNavigation2.fab.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu__navigation, menu);
        return true;
    }
